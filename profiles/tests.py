...
class ProfileTestCase(TestCase):
    def setUp(self):
        ...
        self.userb = User.objects.create_user(username='cfe', password='somepassword2')
    ...
    def test_following(self):
        ...
        qs = second_user_following_whom.filter(user=first)  # from a user, check if other is being followed
